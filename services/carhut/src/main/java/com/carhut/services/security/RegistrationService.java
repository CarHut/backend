...
import com.carhut.database.repository.security.RegistrationTokenRepository;
...
public class RegistrationService {
    ...
    public RegistrationStatus registerInitiate(RegisterUserBody registerUserBody) {
        ...
        if (saveInformationOfUserToDatabase(registerUserBody) == RegistrationStatus.ERROR) {
    ...
    private RegistrationToken generateRegistrationToken(RegisterUserBody registerUserBody) {
        String userId;
        try {
    ...
    private RegistrationStatus saveInformationOfUserToDatabase(RegisterUserBody registerUserBody) {
    ...
    private RegistrationStatus validateRegistrationBody(RegisterUserBody registerUserBody) {
    ...
    private RegistrationStatus usernameValidation(String username) {
    ...
    private RegistrationStatus emailValidation(String email) {
    ...
    public RegistrationStatus verifyAccount(String token) {

...
public class MessageService {
    ...
    public List<Message> getLastTenMessagesWithUser(MessageRequestBody messageRequestBody) throws MessageServiceCannotGetMessagesException {
        try {
            ...
            if (messageRequestBody.getSenderId() == null || messageRequestBody.getRecipientId() == null) {
                return null;
            }

            if (messageRequestBody.getSenderId().equals(messageRequestBody.getRecipientId())) {
                return null;
            }
